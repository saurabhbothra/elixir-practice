defmodule Practice.PracticeTest do
  ...
  test "check for palindrome strings" do
    assert palindrome("naman") == "The Entered Text is a Palindrome."
    assert palindrome("saurabh") == "The Entered Text is not a Palindrome."
  end
end
